...
def open_class(link, runtime, record_class=False, debug_port = 6969, exec_path = "D:\Github\chromedriver_win32\chromedriver.exe", exit_browser = False):
...
open_class("https://meet.google.com/cdt-ahha-qdw?authuser=1", 10,exit_browser=True)